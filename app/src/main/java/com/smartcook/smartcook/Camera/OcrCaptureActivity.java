package com.smartcook.smartcook.Camera;
...
import com.smartcook.smartcook.Pages.CaptureActivity;
        ...
        public void receiveDetections(Detector.Detections<TextBlock> detections) {
            ...
            for (int i = 0; i < items.size(); ++i) {
                ...
                if (item != null && item.getValue() != null) {
                    ...
                    itms.add(item.getValue());
                    Log.d("ITEM", itms.get(i));
            ...
            if(itms.size() > 5){
                ...
                intent.putStringArrayListExtra("Item", itms);
